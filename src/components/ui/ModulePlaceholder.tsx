  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center animate-fade-in">
      <div className="rounded-2xl bg-white p-4 shadow-card">
        <div className="rounded-xl bg-fmp-muted p-4">
      ...
      <Link
        to="/"
        className="mt-6 inline-flex items-center gap-1.5 rounded-full bg-fmp px-4 py-2 text-xs font-medium text-white shadow-glow transition-all hover:-translate-y-0.5"
      >
